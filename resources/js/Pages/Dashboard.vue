...
const props = defineProps(["day", "to", "url", "errors"]);
...
<template>
    <Head>
        ...
        <meta
            name="description"
            :content="`Akbar & Dwi akan menikah pada ${day}.`"
        />
        ...
        >
            <div class="col-md-12 pt-4 boning">
                <p>
                    ...
                    insan yang saling mencintai di banding pernikahan.<span
                        >"</span
                    >
                </p>
                <h4
    ...
    <section>
        <div class="container">
            <div class="col-md-10 offset-md-1" data-aos="flip-up">
                ...
                ><br /><br />Tanpa mengurangi rasa hormat, perkenankan kami
                mengundang Saudara/i untuk hadir dan memberikan doa restu pada
            ...
            <div class="row mt-5">
                <div
                    data-aos="zoom-out"
                    data-aos-delay="200"
                    class="col-md-6 mb-3 order-1"
                >
                    <div class="row">
                        <div class="col-md-12 px-5 couple-ring-1">
                            <img
                                src="/assets/images/A6XhVj86rtHJ.png"
                                alt="Juliet Photo"
                                class="img-fluid rounded-circle"
                            />
                        </div>
                    </div>
                    <h3 class="text-secondary">Dwi</h3>
                    <h3 class="caption display-5">Dwi Wahyu Puji Lestari</h3>
                    <p>
                        Putri dari Pasangan <br />
                        Teguh & Rusnawati
                    </p>
                    <p>Boyolangu - Tulungagung</p>
                </div>
                <div
                    data-aos="zoom-out"
                    data-aos-delay="200"
                ...
                >
                    <div class="row">
                        <div class="col-md-12 px-5 couple-ring-2">
                            <img
                    ...
                    <h3 class="text-secondary">Akbar</h3>
                    <h3 class="caption display-5">Suhadak Akbar</h3>
                    <p>
    ...
    <section>
        <div class="container" style="max-width: 1100px">
            <div class="d-flex justify-content-center mb-5">
                <img
                    src="/assets/images/FtWoCD4On6VX.png"
                    alt="mahkota"
            ...
            <div class="row justify-content-md-center">
                <div
                    class="col-md-4 mt-4 information-wrap"
                    data-aos="fade-up"
                    data-aos-delay="300"
                >
                    <div class="information">
                        ...
                        <p>
                            ...
                            Kabupaten Tulungagung, Jawatimur
                        </p>
                    </div>
                </div>
                <div
                ...
                >
                    <div class="information">
                        ...
                        <p>
                            ...
                            Dsn. Bendolor, Ds. Kalen, RT 02 RW 02, Kec. Kalen,
                            Kabupaten Mojokerto, Jawatimur
                        </p>
                    </div>
                </div>
            </div>
                    ...
                    <table style="font-size: 0.9rem; margin: auto">
                        <tbody>
                            <tr>
                                <td width="50%">
                                    <img
                                        src="/assets/images/PdQRw3U0IbIf.png"
                                        alt="masker"
                                ...
                                <td width="50%">
                                    <img
                                        src="/assets/images/eXhIueJkb0L8.png"
                                        alt="distance"
                                        style="max-width: 80px"
                                    /><br />
                            ...
                            <tr>
                                <td width="50%">
                                    <img
                                        src="/assets/images/bRMpYI1gF1ha.png"
                                        alt="salam"
                                        style="max-width: 80px"
                                    /><br />
                                ...
                                <td width="50%">
                                    <img
                                        src="/assets/images/JtjnSzAWgPPZ.png"
                                        alt="wash"
                                        style="max-width: 80px"
                                    /><br />
            ...
            <div class="col-md-12 text-left">
                ...
                <div class="text-center">
                    <button @click="send()" class="btn btn-primary px-5">
                        Kirim
                        <img
                            src="/assets/images/1IVN9gp5RwiN.png"
                            alt="send icon"
                ...
                <div class="row justify-content-md-center">
                    ...
                    >
                        <div class="media px-3 media-comment">
                            <img
                                class="rounded-circle mr-3 d-sm-block d-md-block d-lg-block"
                    ...
                    <div class="load-button">
                        <button
                            v-if="messages.page < messages.last_page"
                            @click="getMessages()"
    ...
    <div
        class="play-pause btn-play-pause"
        id="player-control"
        @click="musicHandler"
        data-aos="fade-up"
        data-aos-duration="1000"
